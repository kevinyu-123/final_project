				...
				<div class="u-repeater u-repeater-1">
					<div class="u-container-style u-list-item u-repeater-item">
						<div
							...
							<p class="u-align-center u-text u-text-grey-50 u-text-3">
								price : ${menuDTO[0].price } won<br> <br>
							</p>
							<p class="u-text u-text-black u-text-4">${menuDTO[0].ex }</p>
							<img
								src="resources/rest_detail/bootstrap/images/${restDTO.id }/menu/${menuDTO[0].pic }"
								alt=""
						...
						<div class="u-container-style u-list-item u-repeater-item">
							<div
								...
								<p class="u-align-center u-text u-text-grey-50 u-text-9">
									price : ${menuDTO[2].price} won<br>
								</p>
								<p class="u-text u-text-black u-text-10">${menuDTO[2].ex }</p>
								<img src="images/b81dc61f5cc588090e947e2da8347594.jpeg" alt=""
					...
					<c:if test="${mentDTO[2] eq null }">
						<div class="u-container-style u-list-item u-repeater-item">
							<div
								class="u-container-layout u-similar-container u-container-layout-3">
								<h2 class="u-align-center u-text u-text-grey-70 u-text-8">메뉴
									준비중입니다.</h2>
								<p class="u-align-center u-text u-text-grey-50 u-text-9">
									<br>
								</p>
						...
						<div
							...
							<div
								...
								<img
									...
									alt="" data-image-width="512" data-image-height="512">
								<p
									class="u-text u-text-default u-text-palette-5-dark-1 u-text-3">${reviewsDTO[0].rate }.0
									/ 5.0</p>
